...
class CommonTests(unittest.TestCase):
    ...
    def testTZ( self ):
        ...
        assert result == [timezone_names.timezone_mapping.get(name) for name in names], """Got different results for interpretation than expected (expected first, recieved second)\n%s\n%s"""%([timezone_names.timezone_mapping.get(name) for name in names], result)
